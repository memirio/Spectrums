...
function generateOppositesFromKnowledge(conceptLabel: string): string[] {
  ...
  const oppositeMap: Record<string, string[]> = {
    ...
    // More concepts from the sample
    'art-deco': ['organic', 'natural', 'rustic', 'minimal'],
    'aspirant': ['achieved', 'master', 'veteran', 'established'],
    'aspiration': ['contentment', 'satisfaction', 'apathy', 'despair'],
    'aspire': ['contentment', 'apathy', 'despair', 'resignation'],
    'assemblage': ['disassembly', 'separation', 'division', 'isolation'],
    'assembly': ['disassembly', 'separation', 'division'],
    'assertion': ['doubt', 'question', 'ambiguity', 'hesitation'],
    'assertiveness': ['passivity', 'submission', 'timidity', 'hesitation'],
    'astral': ['concrete', 'material', 'mundane', 'terrestrial'],
    'athlete': ['sedentary', 'inactive', 'passive'],
    'atmosphere': ['vacuum', 'void', 'emptiness', 'barren'],
    'atmospheric': ['grounded', 'concrete', 'material', 'tangible'],
    'attention': ['neglect', 'ignorance', 'distraction', 'oblivion'],
    'augmentation': ['reduction', 'diminution', 'decrease', 'minimization'],
    'aura': ['void', 'emptiness', 'absence', 'nothingness'],
    'aurora': ['darkness', 'gloom', 'obscurity'],
    'authenticity': ['artificial', 'synthetic', 'fake', 'artifice'],
    'authoritative': ['submissive', 'passive', 'democratic', 'egalitarian'],
    'authority': ['submission', 'passivity', 'democracy', 'equality'],
    'authorship': ['anonymity', 'collective', 'collaborative'],
    'automotive': ['pedestrian', 'walking', 'stationary'],
    'autonomy': ['dependence', 'submission', 'control', 'restriction'],
    'avatar': ['real', 'physical', 'tangible', 'authentic'],
    'awareness': ['ignorance', 'unconsciousness', 'oblivion', 'unawareness'],
    'awe': ['indifference', 'familiarity', 'contempt', 'disdain'],
    'axial': ['radial', 'spherical', 'omnidirectional'],
    'axis': ['chaos', 'randomness', 'disorder'],
    'baked': ['raw', 'fresh', 'uncooked'],
    'baroque': ['minimal', 'simple', 'plain'],
    'barrier': ['access', 'openness', 'freedom'],
    'based': ['fluid', 'handwritten', 'masonry', 'organic'],
    'caps': ['lowercase', 'mixed-case', 'subtle'],
    'carousel': ['static', 'fixed', 'single'],
    'centrality': ['decentralized', 'scattered', 'distributed'],
    'chiaroscuro': ['flat', 'uniform', 'monotone'],
    'classicism': ['modernism', 'avant-garde', 'experimentation'],
    'cleanliness': ['messy', 'cluttered', 'chaotic'],
    'clustering': ['sparse', 'scattered', 'dispersed'],
    'command': ['suggestion', 'option', 'flexibility'],
    'composition': ['chaos', 'disorder', 'randomness'],
    'concentricity': ['chaotic', 'scattered', 'asymmetric'],
    'contrast': ['uniformity', 'homogeneity', 'blending'],
    'curvature': ['straight', 'linear', 'angular'],
    'design': ['chaos', 'formlessness', 'randomness'],
    'directness': ['indirect', 'ambiguous', 'oblique'],
    'dispersal': ['concentration', 'clustering', 'gathering'],
    'dispersion': ['concentration', 'clustering', 'unity'],
    'display': ['concealment', 'hiding', 'obscurity'],
    'distribution': ['concentration', 'clustering', 'unity'],
    'docs': ['visual', 'graphical', 'illustrated'],
    'dominance': ['submission', 'subordination', 'equality'],
    'drawer': ['static', 'fixed', 'permanent'],
    'drop': ['rise', 'ascent', 'elevation'],
    'dynamism': ['static', 'still', 'stationary'],
    'eclectic': ['unified', 'cohesive', 'consistent'],
    'edge': ['center', 'middle', 'interior'],
    'editorial': ['commercial', 'advertising', 'promotional'],
    'effects': ['static', 'plain', 'simple'],
    'elegant': ['crude', 'rough', 'unrefined'],
    'elements': ['whole', 'unity', 'gestalt'],
    'experimental': ['traditional', 'conventional', 'established'],
    'fashion': ['timeless', 'classic', 'permanent'],
    'focus': ['diffuse', 'scattered', 'unfocused'],
    'font': ['image', 'graphic', 'visual'],
    'fonts': ['images', 'graphics', 'visuals'],
    'geometry': ['organic', 'fluid', 'amorphous'],
    'grace': ['awkwardness', 'clumsiness', 'inelegance'],
    'harmony': ['discord', 'chaos', 'clashing'],
    'header': ['footer', 'bottom', 'end'],
    'image': ['text', 'typography', 'word'],
    'informal': ['formal', 'ceremonial', 'official'],
    'interactions': ['static', 'passive', 'still'],
    'interactive': ['static', 'passive', 'still'],
    'intricate': ['simple', 'minimal', 'basic'],
    'light': ['dark', 'shadow', 'obscurity'],
    'like': ['dislike', 'aversion', 'repulsion'],
    'linearity': ['curved', 'organic', 'flowing'],
    'loading': ['ready', 'complete', 'finished'],
    'luminosity': ['darkness', 'obscurity', 'dimness'],
    'luxurious': ['modest', 'austerity', 'economy'],
    'magazine': ['book', 'novel', 'monograph'],
    'measurement': ['estimation', 'approximation', 'guess'],
    'menu': ['static', 'fixed', 'permanent'],
    'minimalistic': ['maximalist', 'ornamental', 'decorative'],
    'modal': ['static', 'permanent', 'fixed'],
    'modern': ['traditional', 'classical', 'vintage'],
    'monospace': ['proportional', 'variable', 'flexible'],
    'monumental': ['minimal', 'subtle', 'understated'],
    'music': ['silence', 'quiet', 'stillness'],
    'negative': ['positive', 'affirmative', 'constructive'],
    'obscured': ['clear', 'visible', 'transparent'],
    'old': ['new', 'modern', 'contemporary'],
    'ornamentation': ['minimalism', 'simplicity', 'plainness'],
    'page': ['screen', 'digital', 'virtual'],
    'perspective': ['flat', 'two-dimensional', 'planar'],
    'polish': ['roughness', 'texture', 'grain'],
    'portfolio': ['single', 'unified', 'cohesive'],
    'portrait': ['landscape', 'horizontal', 'wide'],
    'product': ['service', 'intangible', 'abstract'],
    'screen': ['print', 'physical', 'tangible'],
    'scroll': ['static', 'fixed', 'stationary'],
    'simplicity': ['complexity', 'elaboration', 'ornamentation'],
    'simplification': ['complexity', 'elaboration', 'ornamentation'],
    'sleekness': ['roughness', 'texture', 'grain'],
    'softness': ['hardness', 'rigidity', 'sharpness'],
    'sophisticated': ['simple', 'naive', 'basic'],
    'space': ['density', 'crowded', 'full'],
    'spacious': ['compact', 'cramped', 'dense'],
    'spatial': ['flat', 'planar', 'two-dimensional'],
    'spontaneity': ['planned', 'deliberate', 'structured'],
    'states': ['static', 'fixed', 'permanent'],
    'superimposition': ['separation', 'isolation', 'distinct'],
    'symmetry': ['asymmetry', 'imbalance', 'chaos'],
    'tension': ['relaxation', 'calm', 'peace'],
    'texture': ['smooth', 'flat', 'glossy'],
    'timeline': ['static', 'frozen', 'still'],
    'type': ['image', 'graphic', 'visual'],
    'ui': ['print', 'physical', 'tangible'],
    'unbounded': ['bounded', 'limited', 'restricted'],
    'underline': ['overline', 'strikethrough', 'none'],
    
    // Design styles and aesthetics
    'skeuomorphic': ['flat', 'minimal', 'digital'],
    'surreal': ['realistic', 'documentary', 'literal'],
    'friendly': ['aloof', 'distant', 'formal'],
    'gradient': ['solid', 'flat', 'uniform'],
    'pastel': ['vibrant', 'bold', 'saturated'],
    'duotone': ['full-color', 'colorful', 'rainbow'],
    'neon': ['muted', 'subtle', 'pastel'],
    'grid-based': ['organic', 'fluid', 'asymmetric'],
    'split-screen': ['single', 'unified', 'whole'],
    'card-based': ['continuous', 'seamless', 'unified'],
    'masonry': ['grid', 'uniform', 'aligned'],
    'hero-led': ['minimal', 'subtle', 'understated'],
    'long-scroll': ['static', 'fixed', 'paged'],
    'magazine-layout': ['web', 'digital', 'minimal'],
    'poster-like': ['document', 'text-heavy', 'informational'],
    'strict': ['flexible', 'playful', 'whimsical'],
    'whimsical': ['serious', 'formal', 'strict'],
    'gritty': ['polished', 'smooth', 'refined'],
    'inviting': ['aloof', 'distant', 'exclusive'],
    'expressive': ['restrained', 'minimal', 'subtle'],
    'cinematic': ['static', 'documentary', 'realistic'],
    'typographic': ['image-heavy', 'visual', 'graphical'],
    'handwritten': ['mechanical', 'digital', 'uniform'],
    'editorial-type': ['display', 'decorative', 'ornamental'],
    'display-type': ['body', 'text', 'readable'],
    'large-type': ['small', 'subtle', 'minimal'],
    'condensed': ['expanded', 'spacious', 'wide'],
    'geometric-type': ['organic', 'handwritten', 'script'],
    'variable-font': ['static', 'fixed', 'rigid'],
    'parallax': ['static', 'flat', 'fixed'],
    'scroll-driven': ['static', 'fixed', 'paged'],
    'motion-heavy': ['static', 'still', 'frozen'],
    'micro-interactions': ['static', 'passive', 'still'],
    'responsive': ['fixed', 'rigid', 'static'],
    'immersive': ['distanced', 'detached', 'superficial'],
    'ecommerce': ['editorial', 'artistic', 'non-commercial'],
    'startup': ['established', 'corporate', 'traditional'],
    'saas': ['on-premise', 'physical', 'tangible'],
    'developer-docs': ['visual', 'graphical', 'illustrated'],
    'landing-page': ['multi-page', 'deep', 'navigational'],
    'complementary': ['monochromatic', 'analogous', 'similar'],
    'earth-tones': ['vibrant', 'neon', 'saturated'],
    'monochromatic': ['colorful', 'rainbow', 'vibrant'],
    'ocean-tones': ['warm', 'fiery', 'amber'],
    'rainbow': ['monochromatic', 'duotone', 'monochrome'],
    'sepia': ['vibrant', 'colorful', 'saturated'],
    'triadic': ['monochromatic', 'analogous', 'similar'],
    'education': ['commercial', 'entertainment', 'leisure'],
    'food': ['abstract', 'conceptual', 'intangible'],
    'government': ['private', 'commercial', 'personal'],
    
    // More design concepts
    'academia': ['commercial', 'practical', 'applied', 'industry'],
    'art': ['utility', 'function', 'practical', 'commercial'],
    'artistic': ['commercial', 'practical', 'utilitarian', 'functional'],
    'based': ['fluid', 'handwritten', 'masonry', 'organic'],
    'caps': ['lowercase', 'mixed-case', 'subtle'],
    ...
    // Even more common concepts
    'accessible': ['exclusive', 'restricted', 'elite'],
    'centered': ['asymmetric', 'offset', 'scattered'],
    'clean': ['messy', 'cluttered', 'busy'],
    'elegant': ['crude', 'rough', 'unrefined'],
    'experimental': ['traditional', 'conventional', 'established'],
    'focused': ['diffuse', 'scattered', 'unfocused'],
    'harmony': ['discord', 'chaos', 'clashing'],
    'intricate': ['simple', 'minimal', 'basic'],
    'luxurious': ['modest', 'austerity', 'economy'],
    'minimalistic': ['maximalist', 'ornamental', 'decorative'],
  ...
  if (lower.endsWith('ness')) {
    ...
    if (base === 'clean') return ['messiness', 'clutter', 'chaos'];
    if (base === 'sleek') return ['roughness', 'texture', 'grain'];
    if (base === 'bright') return ['darkness', 'dimness', 'obscurity'];
    if (base === 'sharp') return ['softness', 'bluntness', 'dullness'];
  }
  ...
  if (lower.endsWith('ity') || lower.endsWith('ty')) {
    ...
    if (base === 'central') return ['decentralized', 'scattered', 'distributed'];
    if (base === 'concentr') return ['scattered', 'dispersed', 'chaotic'];
    if (base === 'curvatur') return ['straightness', 'linearity', 'angularity'];
    if (base === 'linear') return ['curved', 'organic', 'flowing'];
    if (base === 'spontane') return ['planned', 'deliberate', 'structured'];
    if (base === 'luxur') return ['modesty', 'austerity', 'economy'];
    if (base === 'sophisticat') return ['simplicity', 'naivety', 'basic'];
    if (base === 'spatial') return ['flat', 'planar', 'two-dimensional'];
    if (base === 'luminos') return ['darkness', 'obscurity', 'dimness'];
  }
  ...
  if (lower.endsWith('ism')) {
    ...
    if (base === 'classic') return ['modernism', 'avant-garde', 'experimentation'];
    if (base === 'experimental') return ['traditionalism', 'conventional', 'established'];
  }
