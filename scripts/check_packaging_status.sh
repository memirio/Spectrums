#!/bin/bash
# Quick status check for packaging upload

LOG_FILE="/tmp/packaging_upload.log"

echo "📊 Packaging Upload Status Check"
echo "=================================="
echo ""
...
PROCESSED=$(grep -c "\[[0-9]\+/51\] Processing:" "$LOG_FILE" 2>/dev/null || echo "0")
echo "📦 Items processed: $PROCESSED / 51"
